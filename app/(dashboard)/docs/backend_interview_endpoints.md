...
class VacancyStatus(str, Enum):
    ...
    IN_PROGRESS = "in_progress"    # Interview being configured
    AGENT_CREATED = "agent_created"  # Interview agent is live
...
|-----------|------|-------------|
| `status` | string | Filter by status: `new`, `in_progress`, `agent_created`, `archived` |
